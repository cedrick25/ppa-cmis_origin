...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>CARRY OVER COURTESY PROBATION SUPERVISION REFERRALS RECEIVED</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker table-condensed" style="width:100%" id="T_F5T12">
        ...
        <tbody class="F5T12_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
