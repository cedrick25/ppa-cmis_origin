...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>SUPERVISION CASES ACTED UPON</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker text-nowrap" id="T_F44T9">
        <thead class="tb-header">
          ...
          <tr>
            ...
            <th style="text-align: center;">VIOLATION REPORT</th>
            <th style="text-align: center;">TRANSFER TO OTHER OFFICES</th>
          </tr>
        </thead>
        <tbody class="F44T9_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
