...
<div class="container-fluid" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>COURTESY SUPERVISION REFERRALS RECEIVED AND COMPLETED AND TERMINATED</b></h4>
    </div>
  </div><br>
  ...
  <div class="tab-content tab_list">
    <div id="ReferralsReceived" class="tab-pane fade in active">
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T13">
              <thead class="small tb-header">
                ...
                <tr class="tb-header">
                  ...
                  <th style="text-align: center;">PERIOD COURTESY SUPERVISION</th>
              ...
              <tbody class="F45T13_tbody tbody-sm">
    ...
    <div id="menu1" class="tab-pane fade">
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T13_b">
              <thead class="small tb-header">
                <tr>
                  <th colspan="9" style="text-align: center;">COURTESY REFERRALS TERMINATED</th>
                </tr>
                <tr>
                  <th style="text-align: center;">DOCKET NO.</th>
                  <th style="text-align: center;">OFFENDER'S NAME</th>
              ...
              <tbody class="F45T13_tbody_b tbody-sm">
  ...
  <div class="row  print_list">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T13_download_print">
        <thead class="small tb-header">
          <tr>
            <th colspan="8" style="text-align: center;">REFERRALS RECEIVED</th>
            <th colspan="3" style="text-align: center;">COURTESY REFERRALS TERMINATED</th>
          </tr>
          <tr>
            <th style="text-align: center;">DOCKET NO.</th>
            <th style="text-align: center;">OFFENDER'S NAME</th>
        ...
        <tbody class="T_F45T13_download_print_tbody tbody-sm">
