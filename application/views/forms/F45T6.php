...
<div class="container-fluid" style="padding-top: 30px">
  ...
  <div class="tab-content">
    <div id="ReferralsReceived" class="tab-pane fade in active">
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T6">
              ...
              <tbody class="F45T6_tbody tbody-sm">
    ...
    <div id="menu1" class="tab-pane fade">
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T6_b">
              <thead class="small tb-header">
                <tr>
              ...
              <tbody class="F45T6_tbody_b tbody-sm">
