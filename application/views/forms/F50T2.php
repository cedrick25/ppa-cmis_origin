...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>VOLUNTARY CONFINEMENT CASES HANDLED</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker text-nowrap" id="T_F50T2">
        <thead>
          <tr class="tb-header">
            ...
            <th style="text-align: center;">COURT DISPOSITION</th>
        ...
        <tbody class="F50T2_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
