...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>INVESTIGATION CASES DISPOSED OF BY THE EXECUTIVE DIRECTOR</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker text-nowrap" id="T_F44T4">
        <thead>
          <tr class="tb-header">
        ...
        <tbody class="F44T4_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
