...
<div class="container-fluid" style="padding-top: 30px">
        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F44T6">
              ...
              <tbody class="F44T6_tbody tbody-sm">
        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-md-12 div-table" >
            <table class="table table-bordered text-nowrap" style="width:100%" id="T_F44T6_b">
              ...
              <tbody class="F44T6_tbody_b tbody-sm">
  ...
  <div class="row hide print_list">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered text-nowrap" style="width:100%" id="T_F44T6_download_print">
        <thead class="small tb-header">
          <tr>
        ...
        <tbody class="T_F44T6_download_print_tbody tbody-sm">
