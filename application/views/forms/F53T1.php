...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>TABLE 1</b></h4>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>CARRY OVER FOR APPLICATION FOR COMMUNITY SERVICE CASELOAD</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker text-nowrap" id="T_F53T1">
        <thead>
          <tr class="tb-header">
        ...
        <tbody class="F53T1_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
