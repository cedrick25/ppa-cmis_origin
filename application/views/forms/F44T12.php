...
<div class="container" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>CARRY OVER COURTESY SUPERVISION REFERRALS RECEIVED</b></h4>
    </div>
  </div><br>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered table-darker text-nowrap" id="T_F44T12">
        <thead>
          <tr class="tb-header">
            ...
            <th style="text-align: center;">DATE RECEIVED BY PPO</th>
        ...
        <tbody class="F44T12_tbody tbody-sm">
        </tbody>
      </table>
    </div>
  </div>
