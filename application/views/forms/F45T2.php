...
<div class="container-fluid" style="padding-top: 30px">
  ...
  <div class="row hide print_list">
    <div class="col-lg-12 col-sm-12 col-md-12 div-table">
      <table class="table table-bordered text-nowrap" style="width:100%" id="T_F45T2_download_print">
        <thead class="small tb-header">
          <tr>
            <th colspan="5" style="text-align: center;">REFERRALS RECEIVED</th>
        ...
        <tbody class="T_F45T2_download_print_tbody tbody-sm">
