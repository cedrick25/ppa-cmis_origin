				 	...
				 	<div class="row">
				 		...
				 		<div class="col-md-12">
				 			...
				 			<div class="panel panel-primary">
								<div class="panel-heading"> <h3 class="nav-pills" style="margin-top: 5px; margin-bottom: 5px;   font-size: 24px;"><i class="fa fa-list"></i>  Users Levels </h3> </div>
								...
								<div class="panel-body">
							    	...
							    	<span class="pull-right "><button class="btn btn-primary" data-toggle="modal" data-target="#modalAdd">Add User Level</button></span>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
       	<div class="panel panel-primary">
			<div class="panel-heading"> <h3 class="nav-pills" style="margin-top: 5px; margin-bottom: 5px;   font-size: 24px;"><i class="fa fa-pencil"></i>  Update User Level <i class="pull-right fa fa-close"  data-dismiss="modal"></i></h3> </div>
			...
			<div class="panel-body">
				...
				<div class="hidden" id="editBody">
			    	<div class="form-group">
						...
						<input type="hidden" class="form-control" id="txtLevelID">
					</div>
					<div class="form-group">
						<label for="">Modules:</label>
						<div class="edit_modules"></div>
					</div>
	...
	$( window ).ready(function() {
        setTimeout(function () {
        	if($.wms.dashboard.checkPermission("9")){
	    		...
	    		$.wms.dashboard.attachUserLevelEvent();
    		}
        }, 200);
   });
</script>