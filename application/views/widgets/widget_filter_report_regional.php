		...
		<div class="panel panel-primary" >
			...
			<div class="panel-body">
              	...
              	<div class="form-group col-md-9">
	              	<b>Report:</b><br/>
		            <select class="form-control select2 sel" id="sel-report-regional-forms">
	            ...
	            <div class="form-group col-md-2">
            	 	<b>As-of</b><br/>
		            <select class="select2 form-control" id="report-regional-date">
            	...
            	<div class="form-group col-md-1">
            		<br/>
    				<button type="button" class="btn btn-primary btn-regional-filter">Filter</button>  
				</div>
			</div>
		</div>
