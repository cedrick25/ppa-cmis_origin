		...
		<div class="panel panel-primary" >
			...
			<div class="panel-body">
				<div class="form-group col-md-2">
	              	<b>Field Office:</b><br/>
	              	<select class="form-control select2  sel_regional_office" id="sel-report-field">
              		</select>
	            </div>
              	<div class="form-group col-md-6">
	              	<b>Report:</b><br/>
		            <select class="form-control select2 sel" id="sel-report-field-forms">
            	...
            	<div class="form-group col-md-1">
            		<br/>
    				<button type="button" class="btn btn-primary btn-field-filter">Filter</button>  
				</div>
			</div>
		</div>
