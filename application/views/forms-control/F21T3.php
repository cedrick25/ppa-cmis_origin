      ...
      <div class=" hidden modal-body modal-form">
        <div class="row" id="form_">
          <div class="col-lg-12">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Submitted Date </label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control  sel_date2" id="edit_psir">
              </div>
            </div>
           <!--  <div class="form-group row">
              <label for="" class="col-sm-3">Manifestation</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_manifestation" placeholder="">
              </div>
            </div> -->
            <div class="form-group row">
        ...
        <div class="  modal-body modal-form">
          <div class="row" id="form_">
            ...
            <!-- <div class="form-group row">
              <label for="" class="col-sm-3">Manifestation</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="add_manifestation" placeholder="">
              </div>
            </div> -->
              <div class="form-group row">
                <label for="" class="col-sm-3">Investigating Officer</label>
