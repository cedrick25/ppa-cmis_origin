        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_table" disabled="">
                    ...
                    <option value="F21T14_PAROL">PAROLEE</option>
                    <option value="F21T14_PARDON">PARDONEE</option>
                  </select>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control  sel_date2" id="edit_date_rcv">
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_reasons" placeholder="">
              </div>
            </div>
            <div class="form-group row">
        ...
        <div class="  modal-body modal-form">
          <div class="row" id="form_">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Received from the PPO</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control  sel_date2" id="add_date_rcv">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Supervising Officer</label>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Reasons</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="add_reasons" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Case Classification</label>
