          ...
          <div class="col-lg-12">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <span class="font_10 error_msg"><i class="b">Acceptable Docket Series: HCS</i></span>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_sentence" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date of Court Order</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_date_court_order">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Submitted</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_date_submitted">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">PPO's Recommendation</label>
                <div class="col-sm-9 filter-modal">
                  <select class="form-control select2 modal" id="edit_ppo_recommendation">
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Sentence</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_sentence" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date of Court Order</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_date_court_order">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Received</label>
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Submitted</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_date_submitted">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">PPO's Recommendation</label>
                <div class="col-sm-9 filter-modal">
                  <select class="form-control select2 modal" id="add_ppo_recommendation">
                    <option value="GRANT">GRANT</option>
                    <option value="DENIED">DENIED</option>
                  </select>
                </div>
