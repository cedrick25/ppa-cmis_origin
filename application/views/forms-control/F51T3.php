 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f51_write btn btn-sm btn-primary form_lock" data-toggle="modal" data-target="#modal-add"><i class="fa fa-plus-circle"></i> Add New Record</button>
        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Reports Submitted to the court</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_date_report">
                </div>
              </div>
          </div>
        </div>
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Reports Submitted to the court</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_date_report">
                </div>
              </div>
            </div>
          </div>
