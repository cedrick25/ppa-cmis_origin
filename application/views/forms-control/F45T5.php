 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      ...
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f45_write btn btn-sm btn-success btn-carryover"  data-toggle="modal" data-target="#modal-carryover"><i class="fa fa-stack-overflow"></i> Carry Over</button>
      </span>
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><b>Are you sure you want CARRY OVER COURTESY INVESTIGATION REFERRALS RECEIVED?</b></p>
