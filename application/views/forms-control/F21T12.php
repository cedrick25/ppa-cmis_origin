      ...
      <div class=" hidden modal-body modal-form">
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_table" disabled="">
                    ...
                    <option value="F21T12_PAROL">PAROLEE</option>
                    <option value="F21T12_PARDON">PARDONEE</option>
                  </select>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Report Submitted to the Regional Director </label>
              <div class="col-sm-9">
