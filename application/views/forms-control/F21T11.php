        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_table" disabled="">
                    ...
                    <option value="F21T11_PAROL">PAROLEE</option>
                    <option value="F21T11_PARDON">PARDONEE</option>
                  </select>
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Board Resolution</label>
                <div class="col-sm-9 filter-modal">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Specify the Other Resolutions reeived from the Board</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control " id="edit_submitted_report">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Resolution </label>
              <div class="col-sm-9">
      ...
      <div class="modal-content">
        ...
        <div class="  modal-body modal-form">
          <div class="row" id="form_">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Resolution received from the Board</label>
              <div class="col-sm-9">
