 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
    	<span class="pull-right" style="padding-right: 10px;">
    		<button type="button" class="access_f21_write btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add"><i class="fa fa-plus-circle"></i> Add New Record</button>
          ...
          <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_table" disabled="">
                    ...
                    <option value="F21T8_PAROL">PAROLEE</option>
                    <option value="F21T8_PARDON">PARDONEE</option>
                  </select>
            ...
            <div class="form-group row">
              ...
              <div class="form-group row hidden">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control input-sm" id="edit_cc_no" placeholder="">
                </div>
              </div>
              <div class="form-group row hidden">
                <label for="" class="col-sm-3">Type of Refferals</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control input-sm" id="edit_court_origin" placeholder="">
                </div>
              </div>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Supervision Start Date</label>
              <div class="col-sm-9">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Supervision End Date</label>
              <div class="col-sm-9">
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row hidden">
                <label for="" class="col-sm-3">CC no.</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control input-sm" id="add_cc_no" placeholder="">
                </div>
              </div>
              <div class="form-group row hidden">
                <label for="" class="col-sm-3">Type of Refferals</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control input-sm" id="add_court_origin" placeholder="">
                </div>
              </div>
             <div class="form-group row">
              <label for="" class="col-sm-3">Case Classification</label>
