          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Suffix Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_acted_offenders_sname" placeholder="">
                </div>
              </div>
              <div class="form-group row">
...
<!-- Delete Modal -->
<!--   <div class="modal fade" id="modal-delete-rcv" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Suffix Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_acted_offenders_sname" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Report Submitted</label>
