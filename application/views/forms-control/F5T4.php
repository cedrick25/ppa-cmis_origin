        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
           ...
           <!--  <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="" class="col-sm-3">Court Decision</label>
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_psir_rec">
                    <option value="">Please choose</option>
                    <option value="Granted">Granted</option>
                    <option value="Denied">Denied</option>
                    <option value="Withdrawal">Withdrawal</option>
                    <option value="Dismissed">Dismissed due to Death</option>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Reason for Denial/Dismissal</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control " id="edit_reason_denial">
              </div>
            </div>

            <div class="form-group row">
              <label for="" class="col-sm-3">Specify other type of Court Decision</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control " id="edit_other_types">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control  sel_date2" id="edit_psir">
              </div>
            </div>
        ...
        <div class="  modal-body modal-form">
          <div class="row" id="form_">
            <div class="col-lg-12">
             ...
             <!--  <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Court Decision</label>
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="add_psir_rec">
                    <option value="">Please choose</option>
                    <option value="Granted">Granted</option>
                    <option value="Denied">Denied</option>
                    <option value="Withdrawal">Withdrawal</option>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Reason for Denial/Dismissal</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control " id="add_reason_denial">
              </div>
            </div>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Specify other type of Court Decision</label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off" class="form-control " id="add_other_types">
              </div>
            </div>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Order Received from the Court </label>
              <div class="col-sm-9">
                <input type="text" class="form-control  sel_date2" id="add_psir">
              </div>
            </div>
