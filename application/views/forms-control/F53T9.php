 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f53_write btn btn-sm btn-primary form_lock" data-toggle="modal" data-target="#modal-add"><i class="fa fa-plus-circle"></i> Add New Record</button>
      ...
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f53_write btn btn-sm btn-success btn-carryover"  data-toggle="modal" data-target="#modal-carryover"><i class="fa fa-stack-overflow"></i> Carry Over</button>
      </span>
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><b>Are you sure you want CARRY OVER APPLICATION PENDING DISPOSITION IN COURT?</b></p>
          ...
          <div class="col-lg-12">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_assigned_officer" placeholder="">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Community Service Period - Start</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_com_start">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Community Service Period - End</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_com_end">
                </div>
              </div>
          </div>
        </div>
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Assigned Officer</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_assigned_officer" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Received By PPO</label>
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Community Service Period - Start</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_com_start">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Community Service Period - End</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_com_end">
                </div>
              </div>
            </div>
          </div>
