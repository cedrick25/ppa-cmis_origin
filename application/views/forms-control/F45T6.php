 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <span class="pull-right" style="padding-right: 10px;">
        ...
        <button type="button" class="access_f44_write btn-add-acted btn btn-sm btn-primary form_lock" data-toggle="modal" data-target="#modal-add-acted"><i class="fa fa-plus-circle"></i> Add Referrals Completed and Returned</button>
          ...
          <div class="col-lg-12">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <span class="font_10 error_msg"><i class="b">Acceptable Docket Series: CCSI</i></span>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_referring_office" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Received by the PPO</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_date_rcv_by_the_ppo" placeholder="">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Reason for Referral</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_reason_for_referral">
                </div>
              </div>
          </div>
        </div>
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Referring Office</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_referring_office" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Received by the PPO</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_date_rcv_by_the_ppo" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Investigating Officer</label>
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Reason for Referral</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_reason_for_referral">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              <div class="form-group row">
                <label for="" class="col-sm-3">Docket No.</label>
                <div class="col-sm-9   filter-modal ">    
                  <select class="form-control select2 modal docket_list" id="add_docket_no-acted">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's First Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" disabled id="add_offender_fname-acted" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Middle Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" disabled id="add_offender_mname-acted" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Last Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" disabled id="add_offender_lname-acted" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Suffix Name</label>
                <div class="col-sm-9 filter-modal">
                  <input type="text" class="form-control  upperCase" disabled id="add_offender_sname-acted" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Completed And Returned</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_date_com_and_ret-acted" placeholder="">
                </div>
              </div>
            </div>
          </div>
          <div class="confirmAdd-acted hidden center">Make sure all details are correct. Click <b>Confirm</b> button to proceed: </div>
        </div>
        <div class="modal-footer" id="modal_footer">

          <button type="button" class="btn btn-sm btn-secondary addCancelButton-acted" data-dismiss="modal">Cancel</button>
          <button type="button" class="btn btn-sm btn-primary addSubmitButton-acted">Submit</button>
          <button type="button" class="btn btn-sm btn-primary hidden addProceedButton-acted">Confirm <span class="pull-right modal-loader hidden"><i class="fa fa-refresh fa-spin fa-1x fa-fw spin"></i></span></button>
        </div>
      </div>
      <input type="reset" class="hidden btn-reset-acted">
    </form>
  </div>
</div>
<!-- Add Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
              <label for="" class="col-sm-3">Docket No.</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_docket_no-acted" placeholder="">
                <input type="hidden" class="form-control " id="edit_id" placeholder="">
                <span class="font_10 error_msg"><i class="b">Acceptable Docket Series: CCSI</i></span>
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Offender's First Name</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_offender_fname-acted" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Offender's Middle Name</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_offender_mname-acted" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Offender's Last Name</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_offender_lname-acted" placeholder="">
              </div>
            </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Offender's Suffix Name</label>
                <div class="col-sm-9 filter-modal">
                    <select class="form-control select2 modal" id="edit_offender_sname-acted" >
                      <option value=""> </option>
                      <option value="II">II</option>
                      <option value="III">III</option>
                      <option value="IV">IV</option>
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Date Completed And Returned</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_date_com_and_ret-acted" placeholder="">
                </div>
              </div>
          </div>
        </div>
      ...
      <div class="modal-footer" id="modal_footer">
        ...
        <button type="button" class="btn btn-sm btn-secondary editCancelButton-acted" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-sm btn-primary editSubmitButton-acted">Submit</button>
        <button type="button" class="btn btn-sm btn-primary hidden editProceedButton-acted">Confirm <span class="pull-right modal-loader hidden"><i class="fa fa-refresh fa-spin fa-1x fa-fw spin"></i></span></button>
      </div>
    </div>
  </div>
</div>
