 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f44_write btn btn-sm btn-success btn-form-submit cppoIsApproved" data-toggle="modal" data-target="#modal-submit"><i class="fa fa-paper-plane"></i> Submit to CPPO Review</button>
        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Offender's Suffix Name</label>
                <div class="col-sm-9 filter-modal">
                    <select class="form-control select2 modal" id="edit_offender_sname-term" >
                      <option value=""> </option>
                      <option value="II">II</option>
                      <option value="III">III</option>
                      <option value="IV">IV</option>
