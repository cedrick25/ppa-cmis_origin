 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
        ...
        <button type="button" class="access_f5_write btn btn-sm btn-success btn-form-submit cppoIsApproved" data-toggle="modal" data-target="#modal-submit"><i class="fa fa-paper-plane"></i> Submit to CPPO Review</button>
        ...
        <button type="button" class="access_f5_write btn btn-sm btn-primary form_lock" data-toggle="modal" data-target="#modal-cmpltd-add"><i class="fa fa-plus-circle"></i> Add New Courtesy Referral Terminated Record</button>
          ...
          <div class="col-lg-12">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <span class="font_10 error_msg"><i class="b">Acceptable Docket Series: JCPS, CPS</i></span>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Criminal Case No.</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_rcv_case_no" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Court of Origin</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="edit_rcv_court_origin" placeholder="">
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Period of Supervision</label>
              <div class="col-sm-9">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Case Classification</label>
                <div class="col-sm-9 filter-modal">
                   <select class="form-control select2 modal" id="edit_rcv_classification" >
        ...
        <div class="  modal-body modal-form">
          <div class="row" id="form_">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Criminal Case No.</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="add_rcv_case_no" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Court of Origin</label>
              <div class="col-sm-9">
                <input type="text" class="form-control  upperCase" id="add_rcv_court_origin" placeholder="">
              </div>
            </div>
            <div class="form-group row">
              <label for="" class="col-sm-3">Referring Office</label>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Case Classification</label>
                <div class="col-sm-9 filter-modal">
                   <select class="form-control select2 modal" id="add_rcv_classification" >
                    <option value="MINIMUM">MINIMUM</option>
                    <option value="MEDIUM">MEDIUM</option>
                    <option value="MAXIMUM">MAXIMUM</option>
                  </select>
          ...
          <div class="row" id="form_">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="add_fileupload" class="col-md-3 col-form-label">Upload File</label>
                <div class="col-sm-9">
                  <input type="file" class="form-control-file add_fileupload_term form-control" id="add_fileupload_term" accept=".jpg, .png, .pdf, .docx" multiple>
                </div>
              </div>
              <input type="hidden" id="FOId" name="FOId">
              <!-- upload end -->
      ...
      <div class=" hidden modal-body modal-form">
        <div class="row" id="form_">
          <div class="col-lg-12">
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Probatoner's Name</label>
              <div class="col-sm-9">
