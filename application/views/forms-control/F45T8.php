 <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <span class="pull-right" style="padding-right: 10px;">
        <button type="button" class="access_f45_write btn btn-sm btn-primary form_lock" data-toggle="modal" data-target="#modal-add"><i class="fa fa-plus-circle"></i> Add New Record</button>
        ...
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <input type="hidden" class="form-control " id="edit_id" placeholder="">
                  <span class="font_10 error_msg"><i class="b">Acceptable Docket Series: CSS, TCSS</i></span>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Criminal Case Number(CC No.)</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="edit_criminal_case" placeholder="">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Supervising Period Start</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_supervising_start" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Supervising Period End</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="edit_supervising_end" placeholder="">
                </div>
              </div>
          </div>
        </div>
          ...
          <div class="row" id="form_">
            <div class="col-lg-12">
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Criminal Case Number(CC No.)</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  upperCase" id="add_criminal_case" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Court of Origin</label>
              ...
              <div class="form-group row">
                <label for="" class="col-sm-3">Supervising Period Start</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_supervising_start" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-3">Supervising Period End</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control  sel_date2" id="add_supervising_end" placeholder="">
                </div>
              </div>
            </div>
          </div>
