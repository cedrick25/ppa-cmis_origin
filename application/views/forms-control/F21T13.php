      ...
      <div class=" hidden modal-body modal-form">
        <div class="row" id="form_">
          <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-9 filter-modal">
                  <select class="select2 modal" id="edit_table" disabled="">
                    ...
                    <option value="F21T13_PAROL">PAROLEE</option>
                    <option value="F21T13_PARDON">PARDONEE</option>
                  </select>
            ...
            <div class="form-group row">
              <label for="" class="col-sm-3">Date Resolution Received from the Regional Director </label>
              <div class="col-sm-9">
