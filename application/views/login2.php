            		...
            		$.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/api/authenticateSSO',JSON.stringify(payload)).done(function (result) {
                        ...
                        if(result.status == 'SUCCESS'){
		                    ...
		                    if(result.payload.USER_STATUS === '0'){
		                        ...
		                        $.wms.executeExternalPost2(window.location.protocol  + '//uams.probation.gov.ph/ppa-api-uams/wsv1/api/email',JSON.stringify(payloadEmail)).done(function (resultemail) {
