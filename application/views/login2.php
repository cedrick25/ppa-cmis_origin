            		...
            		$.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/api/authenticateSSO',JSON.stringify(payload)).done(function (result) {
                        ...
                        if(result.status == 'SUCCESS'){
		                    ...
		                    if(result.payload.USER_STATUS === '0'){
		                        ...
		                        $.wms.executeExternalPost2('http://192.168.1.200/ppa-api-uams/wsv1/api/insertSMSManually',JSON.stringify(payload3)).done(function (result2) {
		                        ...
		                        $.wms.executeExternalPost2('http://192.168.1.36/ppa-api-uams/wsv1/api/email',JSON.stringify(payloadEmail)).done(function (resultemail) {
