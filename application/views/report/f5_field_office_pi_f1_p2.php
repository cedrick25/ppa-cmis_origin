      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          <tr>
            ...
            <th colspan="3" style="text-align: center;">(E) INVESTIGATION REFERRALS NOT ACTED UPON DUE TO</th>
            <th colspan="1" style="text-align: center;">(F) TOTAL ACTIVE INVEST. CASELOAD</th>
          </tr>
          <tr>
