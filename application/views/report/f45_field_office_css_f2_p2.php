...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-048</b></h4>
      <h4 class="" style=""><b>CMRD-CSS-F2</b></h4>   
      <h4 class="" style=""><b>Page 2</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>FIELD OFFICE QUARTERLY COURT DISPOSITION OF COMMUNITY SERVICE SUPERVISION CASELOAD</b></h4>
      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          <tr>
            ...
            <th colspan="1" rowspan="3" style="text-align: center;">(C) TOTAL CASES TO BE ACTED UPON BY THE COURT</th>
            <th colspan="4" rowspan="1" style="text-align: center;">(D) CASES DISPOSED OF BY COURT</th>
            <th colspan="1" rowspan="3" style="text-align: center;">(E) TOTAL CASES PENDING DISPOSITION BY COURT</th>
          </tr>
          <tr>
            ...
            <th colspan="1" rowspan="2" style="text-align: center;">TOTAL CASES DISPOSED OF BY COURT</th>
          </tr>
