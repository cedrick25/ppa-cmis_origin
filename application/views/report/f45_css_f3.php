...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-049</b></h4>
      <h4 class="" style=""><b>CMRD-CSS-F3</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>FIELD OFFICE QUARTERLY COURTESY COMMUNITY SERVICE SUPERVISION CASELOAD</b></h4>
      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          <tr>
            ...
            <th colspan="1" rowspan="3" style="text-align: center;">(B) TOTAL COURTESY SUPERVISION REFERRALS RECEIVED</th>
            <th colspan="1" rowspan="3" style="text-align: center;">(C) TOTAL COURTESY SUPERVISION CASES HANDLED</th>
            <th colspan="1" rowspan="3" style="text-align: center;">(D) TOTAL COURTESY SUPERVISION REFERRALS TERMINATED</th>
