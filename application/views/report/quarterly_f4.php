...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-065</b></h4>
      <h4 class="" style=""><b>(CMRD-PL-F4)</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>QUARTERLY PRE-PAROLE/EXECUTIVE CLEMENCY INVESTIGATION</b></h4>
        ...
        <thead class="small tb-header">
          <tr>
            <th colspan="1" style="text-align: center;"><span class="curr_reg"></span>
              <br>REGION</th>
            <th colspan="3" style="text-align: center;">TOTAL INVESTIGATION
CASES HANDLED</th>
            <th colspan="7" style="text-align: center;">INVESTIGATION REFERRALS ACTED UPON</th>
...
TION</th>
          ...
          <tr>
            ...
            <th colspan="1" style="text-align: center;">PPI Received</th>
            <th colspan="1" style="text-align: center;">Total</th>
            <th colspan="1" style="text-align: center;">For Parole</th>
            <th colspan="1" style="text-align: center;">For Commutation of Sentence</th>
            <th colspan="1" style="text-align: center;">For Conditional Pardon</th>
            <th colspan="1" style="text-align: center;">For Absolute Pardon</th>
            <th colspan="1" style="text-align: center;">Transfer</th>
