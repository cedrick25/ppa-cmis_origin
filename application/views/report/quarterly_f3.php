...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-064</b></h4>
      <h4 class="" style=""><b>(CMRD-PL-F3)</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>QUARTERLY PROBATION SUPERVISION</b></h4>
        ...
        <thead class="small tb-header">
          <tr>
            <th colspan="1" style="text-align: center;"><span class="curr_reg"></span>
              <br>REGION</th>
            <th colspan="3" style="text-align: center;">TOTAL SUPERVISION
HANDLED</th>
            <th colspan="5" style="text-align: center;">SUPERVISION CASES DROPPED</th>
            <th colspan="1" style="text-align: center;">TOTAL ACTIVE
SUPERVISION</th>
          </tr>
          <tr>
            <th colspan="1" style="text-align: center;">&nbsp;</th>
            <th colspan="1" style="text-align: center;">Carry Over</th>
            <th colspan="1" style="text-align: center;">New Supervision Cases Rec'd</th>
            <th colspan="1" style="text-align: center;">Total</th>
            <th colspan="1" style="text-align: center;">Terminated</th>
            <th colspan="1" style="text-align: center;">Revoked</th>
            <th colspan="1" style="text-align: center;">Transferred</th>
