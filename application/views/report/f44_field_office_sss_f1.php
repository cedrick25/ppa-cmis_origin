...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-035</b></h4>
      <h4 class="" style=""><b>(CMRD-SSS-F1)</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>FIELD OFFICE QUARTERLY SUSPENDED SENTENCE SUPERVISION CASELOAD</b></h4>
      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          <tr>
            ...
            <th colspan="4" style="text-align: center;">(D) SUPERVISION CASES DROPPED</th>
            <th colspan="4" style="text-align: center;">(E) SUPERVISION CASES ACTED UPON BY PPO</th>
