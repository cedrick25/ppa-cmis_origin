...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-047</b></h4>
      <h4 class="" style=""><b>CMRD-CSS-F1</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>FIELD OFFICE QUARTERLY COMMUNITY SERVICE SUPERVISION CASELOAD</b></h4>
      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          <tr>
            ...
            <th colspan="4" rowspan="1" style="text-align: center;">(D) SUPERVISION CASES DROPPED</th>
            <th colspan="4" rowspan="1" style="text-align: center;">(E) SUPERVISION CASES ACTED UPON BY PPO</th>
            <th colspan="1" rowspan="3" style="text-align: center;">(F) TOTAL ACTIVE SUPERVISION CASELOAD</th>
          </tr>
          <tr>
            <th colspan="1" rowspan="2" style="text-align: center;">TERMINATED</th>
            <th colspan="1" rowspan="2" style="text-align: center;">REVOKED</th>
            <th colspan="1" rowspan="2" style="text-align: center;">TRANS. TO OTHER OFFICES</th>
            <th colspan="1" rowspan="2" style="text-align: center;">TOTAL CASES DROPPED</th>
