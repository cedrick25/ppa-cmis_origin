...
<div class="container-fluid" style="padding-top: 30px">
  <div class="row pull-right">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style=""><b>PPA-CMR-FO-039</b></h4>
      <h4 class="" style=""><b>(CMRD-SSI-R2)</b></h4>   
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>REGIONAL QUARTERLY EXECUTIVE DIRECTOR DISPOSITION OF SUSPENDED SENTENCE INVESTIGATION CASELOAD</b></h4>
    ...
    <div class="col-lg-12 col-sm-12 col-md-12">
      ...
      <table class="table table-bordered" id="Table" style="width:100%">
        <thead class="small tb-header">
          ...
          <tr>
            <th colspan="1" style="text-align: center;">GRANTED</th>
            <th colspan="1" style="text-align: center;">DENIED</th>
