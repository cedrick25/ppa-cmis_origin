...
<div class="container-fluid" style="padding-top: 30px">
  ...
  <div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
      <h4 class="" style="text-align: center;"><b>COURTESY PROBATION INVESTIGATION CASELOAD</b></h4>
        ...
        <thead class="small tb-header">
          <tr>
            <th colspan="1" style="text-align: center;"><span class="curr_reg"></span>
              <br>REGION</th>
            <th colspan="3" style="text-align: center;">COURTESY INVESTIGATION
HANDLED</th>
            <th colspan="7" style="text-align: center;">COURTESY INVESTIGATION COMPLETED AND RETURNED</th>
...
RATE</th>
          ...
          <tr>
            ...
            <th colspan="1" style="text-align: center;">Courtesy Inv. Refferals Received</th>
            <th colspan="1" style="text-align: center;">Total</th>
            ...
            <th colspan="1" style="text-align: center;">Within 30 days</th>
            <th colspan="1" style="text-align: center;">Within 31-60 days</th>
            <th colspan="1" style="text-align: center;">Beyond 60 days</th>
            <th colspan="1" style="text-align: center;">&nbsp;</th>
            <th colspan="1" style="text-align: center;">&nbsp;</th>
            <th colspan="1" style="text-align: center;">&nbsp;</th>
          </tr>
