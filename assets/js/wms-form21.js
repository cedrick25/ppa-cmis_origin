                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T2_tbody_a').append("<tr>"+
                                    ...
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.petitioner_name + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T2_tbody_b').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv-modal2 form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.petitioner_name + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
            ...
            if(result.status != undefined && result.status == "SUCCESS"){
                result.payload.forEach(function(data){
                    ...
                    $('.F21T4_tbody').append("<tr>"+
                        ...
                        "<td class='options center'>"+source+"</td>"+
                        "<td align='center' class='options'>" + 
                        "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.petitioner + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T6_tbody_b').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv-modal2 form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.petitioner + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T8_tbody_a').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.probationer + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T8_tbody_b').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv-modal2 form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.probationer + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T15_tbody_c').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv-modal3 form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.probationer + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                        ...
                        if ($.active > 0) {
                            ...
                            result.payload.forEach(function(data){
                                ...
                                $('.F21T15_tbody_d').append("<tr>"+
                                    ...
                                    "<td class='options'>"+source+"</td>"+
                                    "<td align='center' class='options'>" + 
                                    "<button class='access_f21 btn btn-success btn-xs btn-attachment-rcv-modal4 form_lock' data-docket='" + data.docket_no.toUpperCase() + "' data-id='" + data.id + "' data-petitioner='" + data.probationer + "' data-field_office_id='" + data.field_office_id + "'><i class='fa fa-upload'></i> </button> " +
                                    "<button class='access_f21_write btn btn-success btn-xs btn-term-edit form_lock' data-table='F21T15_TERM_PAROL'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                    "<button class='access_f21_write btn btn-danger btn-xs btn-delete form_lock' data-table='F21T15_TERM_PAROL'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>")
                            });
