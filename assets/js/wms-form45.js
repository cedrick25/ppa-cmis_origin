...
$.wms.form45 = (function() {
    ...
    var __attachF45T1PageEvent = function() {
        ...
        var __carryoverF45t1 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t1/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t1?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t1?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        ...
        $.wms.executeExternalGet(api).done(function (result) {
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t1/'+data_id+'?&user='+profid).done(function (result) {
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t1/'+data_id).done(function (result2) {
                    console.log(result2);
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_investigating_officer").val(payload.investigatingOfficer)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t1/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t1/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T2PageEvent = function() {
        ...
        var __ref_received = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t2?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t2?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            }
            $.wms.executeExternalGet(api).done(function (result) {
                console.log(result.content)
                $(".form_loader").removeClass("hidden")
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete").unbind("click").on("click",function(){
                    ...
                    $(".deleteProceedButton").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t2/'+data_id+'?&user='+profid).done(function (result) {
                            $("#modal-delete").modal('toggle')
                            $(".modal-loader").addClass("hidden")
                            $(".deleteProceedButton").attr('disabled',false)
                            if(result.status != undefined && result.status == "SUCCESS"){
                ...
                $(".btn-edit").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t2/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            $("#edit_investigating_officer").val(payload.investigatingOfficer)
                                ...
                                $(".editProceedButton").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t2/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
            ...
            $(".addProceedButton").unbind("click").on("click",function(){
                ...
                console.log(payload)
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t2/create',JSON.stringify(payload)).done(function (result) {
        ...
        var __ref_acted = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t2Acted?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t2Acted?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
                
                //Add
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t2Acted/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                    ...
                    $(".addProceedButton_acted").unbind("click").on("click",function(){
                        ...
                        console.log(payload)
                        $.wms.executeExternalPost('http://192.168.1.33:8000/F45t2Acted/create',JSON.stringify(payload)).done(function (result) {
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete-acted").unbind("click").on("click",function(){
                    ...
                    $(".deleteACTEDProceedButton").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t2Acted/'+data_id+'?&user='+profid).done(function (result) {
                ...
                $(".btn-edit-acted").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t2Acted/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            $("#edit_acted_transfer_to").val(payload.transferTo)
                                ...
                                $(".editProceedACTEDButton").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t2Acted/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T3PageEvent = function() {
        ...
        var __carryoverF45t3 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t3/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t3?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t3?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        $.wms.executeExternalGet(api).done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t3/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t3/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_investigating_officer").val(payload.investigatingOfficer)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t3/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t3/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T4PageEvent = function() {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t4?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t4?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            
            //Add
            $.wms.executeExternalGet('http://192.168.1.33:8000/F45t4/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                console.log(result.response)
                ...
                $(".addProceedButton").unbind("click").on("click",function(){
                    ...
                    console.log(payload)
                    $.wms.executeExternalPost('http://192.168.1.33:8000/F45t4/create',JSON.stringify(payload)).done(function (result) {
        ...
        $.wms.executeExternalGet(api).done(function (result) {
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t4/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t4/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_date_received").val(payload.dateReceivedFromCourt)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t4/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T5PageEvent = function() {
        ...
        var __carryoverF45t5 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t5/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t5?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t5?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        $.wms.executeExternalGet(api).done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t5/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t5/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_reason_for_referral").val(payload.reasonForReferral)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t5/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t5/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T6PageEvent = function() {
        ...
        __rcv = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t6?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t6?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            }
            $.wms.executeExternalGet(api).done(function (result) {
                console.log(result.content)
                $(".form_loader").removeClass("hidden")
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete").unbind("click").on("click",function(){
                    ...
                    $(".deleteProceedButton").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t6/'+data_id+'?&user='+profid).done(function (result) {
                            $("#modal-delete").modal('toggle')
                            $(".modal-loader").addClass("hidden")
                            $(".deleteProceedButton").attr('disabled',false)
                            if(result.status != undefined && result.status == "SUCCESS"){
                ...
                $(".btn-edit").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t6/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            $("#edit_reason_for_referral").val(payload.reasonForReferral)
                                ...
                                $(".editProceedButton").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t6/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
            ...
            $(".addProceedButton").unbind("click").on("click",function(){
                ...
                console.log(payload)
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t6/create',JSON.stringify(payload)).done(function (result) {
        ...
        __CAR = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t6CAR?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t6CAR?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''

                //Add
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t6CAR/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                    console.log(result.response)
                    ...
                    $(".addProceedButton-acted").unbind("click").on("click",function(){
                        ...
                        console.log(payload)
                        $.wms.executeExternalPost('http://192.168.1.33:8000/F45t6CAR/create',JSON.stringify(payload)).done(function (result) {
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete").unbind("click").on("click",function(){
                    ...
                    $(".deleteProceedButton").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t6CAR/'+data_id+'?&user='+profid).done(function (result) {
                            $("#modal-delete").modal('toggle')
                            $(".modal-loader").addClass("hidden")
                            $(".deleteProceedButton").attr('disabled',false)
                            if(result.status != undefined && result.status == "SUCCESS"){
                ...
                $(".btn-edit-acted").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t6CAR/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            // $("#edit_date_rcv_by_the_ppo-acted").val(payload.dateReceivedByPpo)
                                ...
                                $(".editProceedButton-acted").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t6CAR/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T7PageEvent = function() {
        ...
        var __carryoverF45t7 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t7/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t7?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t7?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        $.wms.executeExternalGet(api).done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t7/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t7/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_supervising_end").val(payload.supervisionEnd)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t7/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t7/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T8PageEvent = function() {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t8?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t8?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        $.wms.executeExternalGet(api).done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t8/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t8/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_supervising_end").val(payload.supervisionEnd)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t8/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t8/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T9PageEvent = function() {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t9?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t9?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            
            //Add
            $.wms.executeExternalGet('http://192.168.1.33:8000/F45t9/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                console.log(result.response)
                ...
                $(".addProceedButton").unbind("click").on("click",function(){
                    ...
                    console.log(payload)
                    $.wms.executeExternalPost('http://192.168.1.33:8000/F45t9/create',JSON.stringify(payload)).done(function (result) {
        ...
        $.wms.executeExternalGet(api).done(function (result) {
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t9/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t9/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_supervising_officer").val(payload.supervisingOfficer)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t9/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T10PageEvent = function() {
        ...
        var __carryoverF45t10 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t10/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t10?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t10?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            
            //Add
            $.wms.executeExternalGet('http://192.168.1.33:8000/F45t10/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                console.log(result.response)
                ...
                $(".addProceedButton").unbind("click").on("click",function(){
                    ...
                    console.log(payload)
                    $.wms.executeExternalPost('http://192.168.1.33:8000/F45t10/create',JSON.stringify(payload)).done(function (result) {
        ...
        $.wms.executeExternalGet(api).done(function (result) {
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t10/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t10/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_supervising_officer").val(payload.supervisingOfficer)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t10/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T11PageEvent = function() {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t11?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t11?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            
            //Add
            $.wms.executeExternalGet('http://192.168.1.33:8000/F45t11/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                console.log(result.response)
                ...
                $(".addProceedButton").unbind("click").on("click",function(){
                    ...
                    console.log(payload)
                    $.wms.executeExternalPost('http://192.168.1.33:8000/F45t11/create',JSON.stringify(payload)).done(function (result) {
        ...
        $.wms.executeExternalGet(api).done(function (result) {
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t11/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t11/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_field_offices").val(payload.transferredOffice).trigger('change')
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t11/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
    ...
    var __attachF45T12PageEvent = function() {
        ...
        var __carryoverF45t12 = function(){
            $(".carryoverProceedButton").unbind("click").on("click", function(){
                ...
                console.log(payload);
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t12/carryover',JSON.stringify(payload)).done(function (result) {
        ...
        var api;
        if (officeId === "ALL") {
            var api = 'http://192.168.1.33:8000/F45t12?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
        }else {
            var api = 'http://192.168.1.33:8000/F45t12?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
        }
        $.wms.executeExternalGet(api).done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                $(".deleteProceedButton").unbind("click").on("click",function(){
                    ...
                    $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t12/'+data_id+'?&user='+profid).done(function (result) {
                        $("#modal-delete").modal('toggle')
                        $(".modal-loader").addClass("hidden")
                        $(".deleteProceedButton").attr('disabled',false)
                        if(result.status != undefined && result.status == "SUCCESS"){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t12/'+data_id).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
                    ...
                    if(result2.status != undefined && result2.status == "SUCCESS"){
                        ...
                        $("#edit_reason_for_referral").val(payload.reasonsForReferral)
                            ...
                            $(".editProceedButton").unbind("click").on("click",function(){
                                ...
                                console.log(payload_update)
                                $.wms.executeExternalPut('http://192.168.1.33:8000/F45t12/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                    if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('http://192.168.1.33:8000/F45t12/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45T13PageEvent = function() {
        ...
        __rcv = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t13?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t13?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
            }
            $.wms.executeExternalGet(api).done(function (result) {
                console.log(result.content)
                $(".form_loader").removeClass("hidden")
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete").unbind("click").on("click",function(){
                    ...
                    $(".deleteProceedButton").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t13/'+data_id+'?&user='+profid).done(function (result) {
                            $("#modal-delete").modal('toggle')
                            $(".modal-loader").addClass("hidden")
                            $(".deleteProceedButton").attr('disabled',false)
                            if(result.status != undefined && result.status == "SUCCESS"){
                ...
                $(".btn-edit").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t13/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            $("#edit_date_rcv").val(payload.dateReceived)
                                ...
                                $(".editProceedButton").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t13/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
        ...
        __terminated = function(){
            ...
            var api;
            if (officeId === "ALL") {
                var api = 'http://192.168.1.33:8000/F45t13CRT?yearMonth='+yearMonth+'&page='+page+'&size='+size+''
            }else {
                var api = 'http://192.168.1.33:8000/F45t13CRT?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+''
                
                //Add
                $.wms.executeExternalGet('http://192.168.1.33:8000/F45t13CRT/lookup?yearMonth='+yearMonth+'&officeId='+officeId+'').done(function (result) {
                    console.log(result.response)
                    ...
                    $(".addProceedButton").unbind("click").on("click",function(){
                        ...
                        console.log(payload)
                        $.wms.executeExternalPost('http://192.168.1.33:8000/F45t13/create',JSON.stringify(payload)).done(function (result) {
            ...
            $(document).ready(function () {
                ...
                $(".btn-delete-term").unbind("click").on("click",function(){
                    ...
                    $(".deleteProceedButton-term").unbind("click").on("click",function(){
                        ...
                        $.wms.executeExternalDelete('http://192.168.1.33:8000/F45t13CRT/'+data_id+'?&user='+profid).done(function (result) {
                ...
                $(".btn-edit-term").unbind("click").on("click",function(){
                    ...
                    $(".modal-loader2").removeClass("hidden")
                    $(".modal-form").addClass("hidden")
                    $.wms.executeExternalGet('http://192.168.1.33:8000/F45t13CRT/'+data_id).done(function (result2) {
                        console.log(result2);
                        $(".modal-form input").attr("disabled",false);
                        $(".modal-form select").attr("disabled",false);
                        $(".modal-loader2").addClass("hidden")
                        ...
                        if(result2.status != undefined && result2.status == "SUCCESS"){
                            ...
                            $("#edit_date_com_and_ret-term").val(payload.dateReturned)
                                ...
                                $(".editProceedButton-term").unbind("click").on("click",function(){
                                    ...
                                    console.log(payload_update)
                                    $.wms.executeExternalPut('http://192.168.1.33:8000/F45t13CRT/'+data_id,JSON.stringify(payload_update)).done(function (result) {
                                        if(result.status != undefined && result.status == "SUCCESS"){
                                        var form = "Updated Caseload Form: "+$.wms.urlParam('form')+", Field: "+ $.wms.urlParam('field')+", Date:"+ $.wms.urlParam('date') + ". " + JSON.stringify(result.response);
                                        var payload_audit = {
                                            "created_by" : $.cookie("USER_ID"),
            ...
            $(".addProceedButton-term").unbind("click").on("click",function(){
                ...
                console.log(payload)
                $.wms.executeExternalPost('http://192.168.1.33:8000/F45t13CRT/create',JSON.stringify(payload)).done(function (result) {
    ...
    var __attachF45CSCSPageEvent = function() {
        ...
        $(".certUpload").unbind("click").on("click", function(){
            ...
            if (fileToUpload === undefined) {
                ...
                $.wms.executeFile('http://192.168.1.33:8000/cert/upload?officeId='+officeId+'&yearMonth='+date+'&uploaderId='+$.cookie("USER_ID")+'&formTable=f45',formdata).done(function (result) {
                    console.log(result)
                    if(result){
                        __cert_list_upload();
                ...
                if (result.response.length != 0) {
                    ...
                    result.response.forEach(function(data){
                        ...
                        $('.cert_tbody').append("<tr>"+
                            ...
                            "<td align='center' class='options'><a href="+'http://192.168.1.33:8000/cert/view/'+data.id+"><button class='access_f45_write btn btn-success btn-sm btn-view' data-id='"+data.id+"' data-file_path='"+data.filePath+"' data-file_name='"+data.fileName+"'><i class='fa fa-download'></i> Download</button></a></td></tr>"
                        )
                    });
                } else {
        ...
        if (officeId === "ALL") {
            ...
            $.wms.executeExternalGet('http://192.168.1.33:8000/F45Caseload?id='+officeId+'&yearMonth='+date).done(function (result) {
                console.log(result)
                $('.Id').text(result.id);
                $('.Id1').text(result.id1);
                $('.Id1a').text(result.id1a);
