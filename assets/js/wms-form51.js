    ...
    var __attachF51RORCSPageEvent = function() {
        ...
        $(".certUpload").unbind("click").on("click", function(){
            ...
            if (fileToUpload === undefined) {
                ...
                $.wms.executeFile('http://localhost:8000/cert/upload?officeId='+officeId+'&yearMonth='+date+'&uploaderId='+$.cookie("USER_ID")+'&formTable=f51',formdata).done(function (result) {
                    console.log(result)
                    if(result){
                        __cert_list_upload();
