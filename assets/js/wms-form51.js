...
$.wms.form51 = (function() {
    ...
    var __attachF51T1PageEvent = function() {
        ...
        $.wms.executeExternalGet('http://192.168.1.184:8000/F51t1?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+'').done(function (result) {
    ...
    var __attachF51T2PageEvent = function() {
        ...
        $.wms.executeExternalGet('http://192.168.1.184:8000/F51t2?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+'').done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
    ...
    var __attachF51T3PageEvent = function() {
        ...
        $.wms.executeExternalGet('http://192.168.1.184:8000/F51t3?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+'').done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
    ...
    var __attachF51T4PageEvent = function() {
        ...
        __submitCPPO();
        $.wms.executeExternalGet('http://192.168.1.184:8000/F51t4?yearMonth='+yearMonth+'&officeId='+officeId+'&page='+page+'&size='+size+'').done(function (result) {
            console.log(result.content)
            $(".form_loader").removeClass("hidden")
