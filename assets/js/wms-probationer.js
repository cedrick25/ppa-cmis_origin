...
$.wms.probationer = (function() {
    ...
    var __attachCommunityMasterlist = function() {
        ...
        $(".btn-search").unbind("click").on("click",function(){
	        ...
	        $('#probationer_table').DataTable({
	            ...
	            'ajax': {
	                ...
	                'type': 'GET',
	                "data": {
						"docket_number": $("#docket_number").val(),
			            "first_name": $("#first_name").val(),
			            "middle_name": $("#middle_name").val(),
			            "last_name": $("#last_name").val(),
			            "cc_number": $("#cc_number").val(),
			            "court_of_origin": $("#court_of_origin").val(),
			            "assigned_officer": $("#assigned_officer").val(),
    ...
    return {
        ...
        attachCommunityMasterlist: __attachCommunityMasterlist,
    };
}());
