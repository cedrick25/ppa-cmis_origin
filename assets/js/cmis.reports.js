...
$.wms.reports = (function() {
    ...
    var __form_lock = function(){
        ...
        if (analyst != "false") {
            ...
            function timeout2(){
                ...
                $.wms.executeExternalPost(Expansion_api+'form/isApproved',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2)
        ...
        if (officeId === "ALL") {
            ...
            function checkPendingRequest() {
                if ($.active > 0) {
                    ...
                    $.wms.executeExternalPost(Expansion_api+'form/islocked',JSON.stringify(payload)).done(function (result) {
                        console.log(result)
    ...
    var __form_review = function(){
        ...
        // $('.rlist_tbody').empty();
        $.wms.executeExternalPost(Expansion_api+'form/approval-list',JSON.stringify(payload)).done(function (result) {
            console.log(result)
                ...
                "drawCallback": function( settings ) {
                    $(".btn-approve").unbind("click").on("click",function(){
                        ...
                        $(".btnApprove").unbind("click").on("click",function(){
                            ...
                            $.wms.executeExternalPost(Expansion_api+'form/update/'+data_id+'?actionStatus=APPROVED',JSON.stringify(payload)).done(function (result) {
                                ...
                                switch(data_form_table){
                                    ...
                                    case "F44" : 
                                        ...
                                        form44list.forEach(function(item) {
                                            ...
                                            $.wms.executeExternalPost(Expansion_api+''+item+'/carryover',JSON.stringify(payload)).done(function (result) {
                    ...
                    $(".btn-reject").unbind("click").on("click",function(){
                        ...
                        $(".btnReject").unbind("click").on("click",function(){
                            ...
                            $.wms.executeExternalPost(Expansion_api+'form/update/'+data_id+'?actionStatus=REJECTED',JSON.stringify(payload)).done(function (result) {
