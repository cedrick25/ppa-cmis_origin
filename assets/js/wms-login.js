...
$.wms.login = (function() {
    ...
    var __attachLoginEvent = function() {
        ...
        $("#txtUsername").focus();
        if ($.wms.dashboard && typeof $.wms.dashboard.navHighlight === 'function') {
            ...
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/api/authenticate',JSON.stringify(payload)).done(function (result) {
                ...
                if(result.status == 'SUCCESS'){
                    ...
                    if(result.payload.USER_STATUS === '0'){
                        ...
                        $.wms.executeExternalPost(window.location.protocol + '//otp.probation.gov.ph/ppa-api-uams/wsv1/api/insertSMSManually',JSON.stringify(payload3)).done(function (result2) {
                        ...
                        $.wms.executeExternalPost('https://eppcmis.probation.gov.ph/ppa-api-uams/wsv1/api/email',JSON.stringify(payloadEmail)).done(function (resultemail) {
