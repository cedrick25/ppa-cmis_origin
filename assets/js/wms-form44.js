...
$.wms.form44 = (function() {
    ...
    var __attachF44T1PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T1ByYM',JSON.stringify(payload)).done(function (result) {
                ...
                result.payload.forEach(function(data){
                   data = $.wms.upper($.wms.sanitize(data))
                    ...
                    $('.F44T1_tbody').append("<tr>"+
                                                ...
                                                "<td align='center' class='options'> <button class='access_F44_write btn btn-success btn-sm btn-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i> Update</button> "+
                                                "<button class='access_F44_write btn btn-danger btn-sm btn-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i> Delete</button> </td></tr>")
                });
            }else{
                $('.F44T1_tbody').append("<tr>"+
            ...
            $(".btn-delete").unbind("click").on("click",function(){
                ...
                var payload = {
                    "checkTable" : ['F44T2_ACTED','F44T2_NOTACTED'],
                    "Y_M" : $.wms.urlParam('date'),
                    "docket_no" : docket_no,
                    "field_office" : $.wms.urlParam('field')
                }
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T1ByID',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
        ...
        $(".editProceedButton").unbind("click").on("click",function(){
            ...
            console.log(payload)
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/updateF44T1',JSON.stringify(payload)).done(function (result) {
                $(".modal-loader").addClass("hidden")
                $(".editProceedButton").attr('disabled',false)
                $("#modal-edit").modal('toggle')
                if(result.status != undefined && result.status == "SUCCESS"){
                    // __attachF44T1PageEvent();
                    location.reload();
                }else{
                    //Error Prompt
                }
        ...
        $(".addProceedButton").unbind("click").on("click",function(){
            ...
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/upsertF44T1',JSON.stringify(payload)).done(function (result) {
                $(".modal-loader").addClass("hidden")
    ...
    var __attachF44T2PageEvent = function() {
        ...
        $(".form_loader").removeClass("hidden")
        $(".result_form").addClass("hidden")
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_RCV_ByYM',JSON.stringify(payload)).done(function (result) {
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
            if(result.status != undefined && result.status == "SUCCESS"){
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c13").html("<button class='access_F44_write btn btn-success btn-xs btn-rcv-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-rcv-delete hidden' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                            r += 1;
                        });
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_ACTED_ByYM',JSON.stringify(payload)).done(function (result) {
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
            if(result.status != undefined && result.status == "SUCCESS"){
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c22").html("<button class='access_F44_write btn btn-success btn-xs btn-acted-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-acted-delete hidden' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                            r += 1;
                        });
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_NOTACTED_ByYM',JSON.stringify(payload)).done(function (result) {
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
            if(result.status != undefined && result.status == "SUCCESS"){
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c27").html("<button class='access_F44_write btn btn-success btn-xs btn-notacted-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-notacted-delete hidden' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           ...
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c31").html("<button class='access_F44_write btn btn-success btn-xs btn-notacted-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-notacted-delete hidden' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
        ...
        $(".addSubmitRCVButton").unbind("click").on("click",function(){
            ...
            var check = true
            var checkTable = ['F44T1', 'F44T2_RCV']
        ...
        $(".addProceedRCVButton").unbind("click").on("click",function(){
            ...
            console.log(payload);
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/upsertF44T2_RCV',JSON.stringify(payload)).done(function (result) {
                $(".modal-loader").addClass("hidden")
                ___modalReset();
        ...
        $(".addCancelACTEDButton").unbind("click").on("click",function(){
         ...
         $(".addProceedACTEDButton").unbind("click").on("click",function(){
            ...
            console.log(payload);
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/upsertF44T2_ACTED',JSON.stringify(payload)).done(function (result) {
                $(".modal-loader").addClass("hidden")
                ___modalReset();
        ...
        $(".addProceedNOTACTEDButton").unbind("click").on("click",function(){
            ...
            console.log(payload);
            $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/upsertF44T2_NOTACTED',JSON.stringify(payload)).done(function (result) {
                $(".modal-loader").addClass("hidden")
                ___modalReset();
                $(".addSubmitNOTACTEDButton").removeClass("hidden")
                $(".addProceedNOTACTEDButton").addClass("hidden")
        ...
        var ___updateRCV_event = function(){
            ...
            $(".deleteRCVProceedButton").unbind("click").on("click",function(){
                ...
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/updateF44T2_RCV',JSON.stringify(payload)).done(function (result) {
            ...
            $(".btn-rcv-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_RCV_ByID',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-loader2").addClass("hidden")
                    $(".modal-form").removeClass("hidden")
                    if(result2.status != undefined && result2.status == "SUCCESS"){
        ...
        var ___updateACTED_event = function(){
            ...
            $(".deleteACTEDProceedButton").unbind("click").on("click",function(){
                ...
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/updateF44T2_ACTED',JSON.stringify(payload)).done(function (result) {
            ...
            $(".btn-acted-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_ACTED_ByID',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-loader2").addClass("hidden")
                    $(".modal-form").removeClass("hidden")
                    if(result2.status != undefined && result2.status == "SUCCESS"){
        ...
        var ___updateNOTACTED_event = function(){
            ...
            $(".deleteNOTACTEDProceedButton").unbind("click").on("click",function(){
                ...
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/updateF44T2_NOTACTED',JSON.stringify(payload)).done(function (result) {
            ...
            $(".btn-notacted-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/fetchF44T2_NOTACTED_ByID',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-loader2").addClass("hidden")
                    $(".modal-form").removeClass("hidden")
                    if(result2.status != undefined && result2.status == "SUCCESS"){
    ...
    var __attachF44T3PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T3',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
                result.payload.forEach(function(data){
                    ...
                    $('.F44T3_tbody').append("<tr>"+
                                                ...
                                                "<td width='15%' align='center' class='options'> <button class='access_F44_write tn btn-success btn-sm btn-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i> Update</button> "+
                                                "<button class='access_F44_write btn btn-danger btn-sm btn-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i> Delete</button> </td></tr>")
                });
                ___tableControls();
            }else{
        ...
        $(".addSubmitButton").unbind("click").on("click",function(){
            ...
            var check = true
            var checkTable = ['F44T3', 'F44T2_ACTED']
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T3',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T4PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T4',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
                result.payload.forEach(function(data){
                    ...
                    $('.F44T4_tbody').append("<tr>"+
                                                ...
                                                "<td class='options center'>"+data.field_office+"</td>"+
                                                "<td class='options center'>"+source+"</td>"+
                                                "<td width='15%' align='center' class='options'> <button class='access_F44_write btn btn-success btn-sm btn-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i> Update</button> "+
                                                "<button class='access_F44_write btn btn-danger btn-sm btn-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i> Delete</button> </td></tr>")
                });
                ___tableControls();
            }else{
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T4',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T5PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T5',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
        ...
        $(".addSubmitButton").unbind("click").on("click",function(){
            ...
            var requiredField= [ 'add_petitioner', 'add_date_rcv', 'add_investigating_officer'];
            var check = true
            var checkTable = ['F44T5', 'F44T6_RCV']
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T5',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T6PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T6_RCV',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c9").html("<button class='access_F44_write tn btn-success btn-xs btn-rcv-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-rcv-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("");
                            r += 1;
                        });
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T6_CMPLTD',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c14").html("<button class='access_F44_write btn btn-success btn-xs btn-cmpltd-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-cmpltd-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                            r += 1;
                        });
        ...
        $(".addRCVSubmitButton").unbind("click").on("click",function(){
            ...
            var check = true
            var checkTable = ['F44T6_RCV', 'F44T5']
        ...
        var ___tableControlsRCV = function(){
            ...
            $(".btn-rcv-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T6_RCV',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
        ...
        var ___tableControlsCMPLTD = function(){
            ...
            $(".btn-cmpltd-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T6_CMPLTD',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T7PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T7',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
                result.payload.forEach(function(data){
                   data = $.wms.upper($.wms.sanitize(data))
                    ...
                    $('.F44T7_tbody').append("<tr>"+
                                                ...
                                                "<td class='options center'>"+data.field_office+"</td>"+
                                                "<td class='options center'>"+source+"</td>"+
                                                "<td width='15%' align='center' class='options'> <button class='btn btn-success btn-sm btn-edit access_F44_write' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i> Update</button> "+
                                                "<button class='access_F44_write btn btn-danger btn-sm btn-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i> Delete</button> </td></tr>")
                });
                ___tableControls();
            }else{
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T7',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T8PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T8',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T8',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T9PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T9',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T9',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T10PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T10',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T10',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T11PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T11',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
                result.payload.forEach(function(data){
                    ...
                    $('.F44T11_tbody').append("<tr>"+
                                                ...
                                                "<td class='options center'>"+source+"</td>"+
                                                "<td width='15%' align='center' class='options'> <button class='access_F44_write btn btn-success btn-sm btn-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i> Update</button> "+
                                                "<button class='btn btn-danger access_F44_write btn-sm btn-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i> Delete</button> </td></tr>")
                });
                ___tableControls();
            }else{
                $(".F44T11_tbody").append(
        ...
        $(".addSubmitButton").unbind("click").on("click",function(){
            ...
            var requiredField= [ 'add_probationer','add_submitted'];
            var check = true
            var checkTable = ['F44T9', 'F44T10']

            ___validateSave(allowedDocket,$("#add_docket_no"),requiredField,check,checkTable).done(function(result){
                if(result){
                    var checkTable2 = ['F44T11']
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T11',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T12PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T12',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            if(result.status != undefined && result.status == "SUCCESS"){
        ...
        $(".addSubmitButton").unbind("click").on("click",function(){
            ...
            var check = true
            var checkTable = ['F44T12', 'F44T13_RCV']        
        ...
        var ___tableControls = function(){
            ...
            $(".btn-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T12',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
    ...
    var __attachF44T13PageEvent = function() {
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T13_RCV',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c12").html("<button class='access_F44_write btn btn-success btn-xs btn-rcv-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-rcv-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                            r += 1;
                        });
        ...
        $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T13_TERM',JSON.stringify(payload)).done(function (result) {
            console.log(result);
            $(".form_loader").addClass("hidden")
            $(".result_form").removeClass("hidden")
            __counter += 1;
                    ...
                    if ($.active > 0) {
                        ...
                        result.payload.forEach(function(data){
                           data = $.wms.upper($.wms.sanitize(data))
                            ...
                            $("#r"+r+"c17").html("<button class='access_F44_write btn btn-success btn-xs btn-cmpltd-edit' data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-pencil'></i></button> "+
                                                "<button class='access_F44_write btn btn-danger btn-xs btn-cmpltd-delete hidden'  data-docket='"+data.docket_no.toUpperCase()+"' data-id='"+data.id+"'><i class='fa fa-trash'></i></button> </td></tr>").addClass("options");
                            r += 1;
                        });
        ...
        $(".addRCVSubmitButton").unbind("click").on("click",function(){
            ...
            var check = true
            var checkTable = ['F44T13_RCV', 'F44T12']        
        ...
        var ___tableControlsRCV = function(){
            ...
            $(".btn-rcv-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T13_RCV',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
        ...
        var ___tableControlsCMPLTD = function(){
            ...
            $(".btn-cmpltd-edit").unbind("click").on("click",function(){
                ...
                $(".modal-loader2").removeClass("hidden")
                $(".modal-form").addClass("hidden")
                $.wms.executeExternalPost('/ppa-cmis-api_origin/wsv1/Cmis/F44T13_TERM',JSON.stringify(payload)).done(function (result2) {
                    console.log(result2);
                    $(".modal-form input").attr("disabled",false);
                    $(".modal-form select").attr("disabled",false);
                    $(".modal-loader2").addClass("hidden")
